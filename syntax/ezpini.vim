...
syn match  ezpiniLabel      "^.\{-}\[\]$"
syn match  ezpiniBoolean    "enabled"
syn match  ezpiniBoolean    "disabled"
syn match  ezpiniBoolean    "true"
syn match  ezpiniBoolean    "false"
...
if version >= 508 || !exists("did_ezpini_syntax_inits")
  if version < 508
    ...
    HiLink ezpiniHeader Keyword
    HiLink ezpiniComment    Comment
    HiLink ezpiniLabel  Type
    HiLink ezpiniBoolean Boolean
